# Runbook — sdkwork-customerservice deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-customerservice-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-customerservice/bundle`, loads the image, starts
