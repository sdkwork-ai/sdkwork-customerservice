...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `customer-service-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `customer-service-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `customer-service-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `customer-service-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `customer-service.sdkwork.com` | 443 ssl + 80 |
